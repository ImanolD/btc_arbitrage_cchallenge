...
export function StatsPanel({ open, stats, onClose }: Props) {
  ...
  return (
    ...
    >
      <div
        className="relative flex max-h-[90vh] w-full flex-col overflow-hidden rounded-t-2xl border border-border bg-card shadow-xl sm:max-h-[88vh] sm:max-w-3xl sm:rounded-2xl"
